...
public final class Taint {
     ...
     * @hide
     */
    native public static void TaintException(String sink);

    /**
     * @hide
     */
    native public static void RemoveTaintString(String s);
	
    /**
     * @hide
     */
   native public static void RemoveTaintDouble(double d);
