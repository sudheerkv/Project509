 ...
 *
 */
static void Dalvik_dalvik_system_Taint_RemoveTaintString(const u4* args, 
							 JValue* pResult)
{
	StringObject *strObj =(StringObject*) args[0];
	//u4 tag = args[1];
...

{
    ...
    u4 vtaint  = args[4];	     
    memcpy(&val, &args[0], 8);	     
    *rtaint = (vtaint & TAINT_CLEAR);
    RETURN_LONG(val);

}	

/*
 * public static void TaintException
 */
static void Dalvik_dalvik_system_Taint_TaintException(const u4* args,
						      JValue* pResult)
{
	StringObject* msgObj = (StringObject*)args[0];
	char *msg;
	...
	msg = dvmCreateCstrFromString(msgObj);
	dvmThrowIllegalAccessException(msg);
	free(msg);
	RETURN_VOID();
}
const DalvikNativeMethod dvm_dalvik_system_Taint[] = {
    ...
    { "RemoveTaintString", "(Ljava/lang/String;)V",
	Dalvik_dalvik_system_Taint_RemoveTaintString},
    {"RemoveTaintDouble", "(DI)D",
    	Dalvik_dalvik_system_Taint_RemoveTaintDouble},
    {"TaintException", "(Ljava/lang/String;)V",
    	Dalvik_dalvik_system_Taint_TaintException},
    { NULL, NULL, NULL },
};
